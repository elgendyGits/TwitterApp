...
import com.android.twitterapp.custom.tweetview.data.FormattedTweetText;
import com.android.twitterapp.custom.tweetview.data.TweetScribeClientImpl;
import com.android.twitterapp.custom.tweetview.data.TweetTextLinkifier;
import com.android.twitterapp.custom.tweetview.data.VideoScribeClientImpl;
import com.android.twitterapp.custom.tweetview.listeners.LinkClickListener;
import com.android.twitterapp.custom.tweetview.listeners.TweetScribeClient;
import com.android.twitterapp.custom.tweetview.utils.TweetDateUtils;
import com.android.twitterapp.custom.tweetview.utils.TweetUtils;
import com.android.twitterapp.custom.tweetview.utils.Utils;
...
abstract class AbstractTweetView extends RelativeLayout{
    ...
    static final int DEFAULT_STYLE = com.twitter.sdk.android.tweetui.R.style.tw__TweetLightStyle;
    ...
    // Dependency Provider
    final AbstractTweetView.DependencyProvider dependencyProvider;
    ...
    void findSubviews() {
        ...
        fullNameView = (TextView) findViewById(com.twitter.sdk.android.tweetui.R.id.tw__tweet_author_full_name);
        screenNameView = (TextView) findViewById(com.twitter.sdk.android.tweetui.R.id.tw__tweet_author_screen_name);
        mediaContainer =
                (AspectRatioFrameLayout) findViewById(com.twitter.sdk.android.tweetui.R.id.tw__aspect_ratio_media_container);
        tweetMediaView = (TweetMediaView) findViewById(com.twitter.sdk.android.tweetui.R.id.tweet_media_view);
        contentView = (TextView) findViewById(com.twitter.sdk.android.tweetui.R.id.tw__tweet_text);
        mediaBadgeView = (MediaBadgeView) findViewById(com.twitter.sdk.android.tweetui.R.id.tw__tweet_media_badge);
    }
    ...
    private void setPermalinkLauncher() {
        final OnClickListener listener = new AbstractTweetView.PermalinkClickListener();
    ...
    void setContentDescription(Tweet displayTweet) {
        if (!TweetUtils.isTweetResolvable(displayTweet)) {
            setContentDescription(getResources().getString(com.twitter.sdk.android.tweetui.R.string.tw__loading_tweet));
            return;
        }
        ...
        setContentDescription(getResources().getString(com.twitter.sdk.android.tweetui.R.string.tw__tweet_content_description,
