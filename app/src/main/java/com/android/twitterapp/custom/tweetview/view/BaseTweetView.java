...
import com.android.twitterapp.custom.tweetview.listeners.ResetTweetCallback;
import com.android.twitterapp.custom.tweetview.utils.ColorUtils;
...
public abstract class BaseTweetView extends AbstractTweetView {
    ...
    void findSubviews() {
        ...
        tweetActionBarView = (TweetActionBarView) findViewById(R.id.tw__custom_tweet_action_bar);
