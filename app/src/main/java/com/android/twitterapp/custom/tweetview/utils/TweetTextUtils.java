...
import com.android.twitterapp.custom.tweetview.data.FormattedMediaEntity;
import com.android.twitterapp.custom.tweetview.data.FormattedTweetText;
import com.android.twitterapp.custom.tweetview.data.FormattedUrlEntity;
...
public final class TweetTextUtils {
     ...
     */
    public static void adjustIndicesForEscapedChars(
     ...
     */
    public static void adjustIndicesForSupplementaryChars(StringBuilder content,
     ...
     */
    public static void adjustEntitiesWithOffsets(List<? extends FormattedUrlEntity> entities,
