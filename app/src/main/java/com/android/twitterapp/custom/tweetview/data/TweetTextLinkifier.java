...
public final class TweetTextLinkifier {
     ...
     */
    public static List<FormattedUrlEntity> mergeAndSortEntities(final List<FormattedUrlEntity> urls,
    ...
    public static FormattedUrlEntity getEntityToStrip(String tweetText, List<FormattedUrlEntity> combined,
                                               boolean stripQuoteTweet, boolean stripVineCard) {
    ...
    public static String stripLtrMarker(String tweetText) {
    ...
    public static boolean isPhotoEntity(final FormattedUrlEntity urlEntity) {
        return urlEntity instanceof FormattedMediaEntity &&
                TweetMediaUtils.PHOTO_TYPE.equals(((FormattedMediaEntity) urlEntity).type);
    }

    public static boolean isQuotedStatus(final FormattedUrlEntity urlEntity) {
        return QUOTED_STATUS_URL.matcher(urlEntity.expandedUrl).find();
    }

    public static boolean isVineCard(final FormattedUrlEntity urlEntity) {
